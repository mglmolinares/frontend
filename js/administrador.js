...
const editarUsuarios = (button) => {
  ...
  axios.get(`https://backend1-eta-ebon.vercel.app/obtener_usuario/${id}`, {
    headers: {
...
const editarTareas = (button) => {
  ...
  axios.get(`https://backend1-eta-ebon.vercel.app/obtener_tareas_id/${id}`, {
    headers: {
      'Content-Type': 'application/json',
...
const guardarCambiosTareas = () => {
  ...
  axios({
    method: 'PUT',
    url: `https://backend1-eta-ebon.vercel.app/editar_tarea/${id}`,
    data: {
...
const cargarLote = () => {
  ...
  axios({
    method: 'GET',
    url: 'https://backend1-eta-ebon.vercel.app/obtener_lotes',
...
const agregarLote = (event) => {
  ...
  axios({
    method: 'POST',
    url: 'https://backend1-eta-ebon.vercel.app/crear_lote',
    data: {
      id_galpon: id_galpon,
...
const guardarCambiosLote = () => {
  ...
  axios({
    method: 'PUT',
    url: `https://backend1-eta-ebon.vercel.app/actualizar_lote/${id_lote}`,
    data: {
      num_aves: num_aves_lote,
      fecha_ingreso: fecha_ingreso,
      id_galpon: id_galpon
...
const agregarGalpon = (event) => {
  ...
  axios({
    method: 'POST',
    url: 'https://backend1-eta-ebon.vercel.app/crear_galpon',
    data: {
      capacidad: capacidad,
      aves: numAves
    },
...
const cargarGalpones = () => {
  axios({
    method: 'GET',
    url: 'https://backend1-eta-ebon.vercel.app/obtener_galpones',
...
const guardarCambiosGalpon = () => {
  ...
  axios({
    method: 'PUT',
    url: `https://backend1-eta-ebon.vercel.app/actualizar_galpon/${id_galpon}`,
    data: {
      capacidad: capacidad,
      aves: num_aves
    },
