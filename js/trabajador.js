...
const guardarEstado = () => {
    ...
    axios({
        method: 'PUT',
        url: `https://backend1-eta-ebon.vercel.app/actualizar_estado/${id_tarea}`,
        data: {
...
const cargarLotes = () => {
    // const token = localStorage.getItem('token');
    axios.get('https://backend1-eta-ebon.vercel.app/obtener_lotes', {
        headers: {
            'Content-Type': 'application/json',
            // 'Authorization': `Bearer ${token}`
        }
...
const registroHuevos = (event) => {
    ...
    axios({
        method: 'POST',
        url: 'https://backend1-eta-ebon.vercel.app/agregar_huevos',
        data: {
            cantidad: cantidad,
            fecha: fecha,
            id_lote: idLote
...
const cargarHuevos = () => {
    // const token = localStorage.getItem('token');
    axios.get('https://backend1-eta-ebon.vercel.app/obtener_huevos', {
        headers: {
            'Content-Type': 'application/json',
            // 'Authorization': `Bearer ${token}`
        }
...
//     axios({
//         method: 'PUT',
//         url: `https://backend1-eta-ebon.vercel.app/editar_galpon/${id_galpon}`,
//         data: {
...
const cargarGalpones = () => {
    // const token = localStorage.getItem('token');
    axios.get('https://backend1-eta-ebon.vercel.app/obtener_galpones', {
        headers: {
            'Content-Type': 'application/json',
            // 'Authorization': `Bearer ${token}`
        }
